...
export const mapDataRaw = [
  ...
  {
    name: "Hanuri - Quán ăn Hàn Quốc",
    lat: "10.77236224278018",
    lng: "106.66958869333563",
    description:
      "Nhà hàng bình dân, sáng sủa, sặc sỡ phục vụ các loại đồ uống và món ăn truyền thống kiểu Hàn.",
    images: [hanuri1, hanuri2, hanuri3],
    period: "Hiện đại",
    region: "Nam",
    province: "TP. Hồ Chí Minh",
    locationType: "food",
  },
  {
    ...
    lat: "10.828991328595986",
    lng: "106.72190246871199",
    description:
...
export const mapData = mapDataRaw.map((e) => ({
  ...
  locationType: e.locationType || "heritage",
}));
